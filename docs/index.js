...
var ASM_CONSTS = {
  93432: () => { if (document.fullscreenElement) return 1; },  
 93478: () => { return Module.canvas.width; },  
 93510: () => { return parseInt(Module.canvas.style.width); },  
 93558: () => { document.exitFullscreen(); },  
 93585: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 93658: () => { if (document.fullscreenElement) return 1; },  
 93704: () => { return Module.canvas.width; },  
 93736: () => { return screen.width; },  
 93761: () => { document.exitFullscreen(); },  
 93788: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 93921: () => { return window.innerWidth; },  
 93947: () => { return window.innerHeight; },  
 93974: () => { if (document.fullscreenElement) return 1; },  
 94020: () => { return Module.canvas.width; },  
 94052: () => { return parseInt(Module.canvas.style.width); },  
 94100: () => { if (document.fullscreenElement) return 1; },  
 94146: () => { return Module.canvas.width; },  
 94178: () => { return screen.width; },  
 94203: () => { return window.innerWidth; },  
 94229: () => { return window.innerHeight; },  
 94256: () => { if (document.fullscreenElement) return 1; },  
 94302: () => { return Module.canvas.width; },  
 94334: () => { return screen.width; },  
 94359: () => { document.exitFullscreen(); },  
 94386: () => { if (document.fullscreenElement) return 1; },  
 94432: () => { return Module.canvas.width; },  
 94464: () => { return parseInt(Module.canvas.style.width); },  
 94512: () => { document.exitFullscreen(); },  
 94539: ($0) => { Module.canvas.style.opacity = $0; },  
 94577: () => { return screen.width; },  
 94602: () => { return screen.height; },  
 94628: () => { return window.screenX; },  
 94655: () => { return window.screenY; },  
 94682: () => { return window.devicePixelRatio; },  
 94718: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 94771: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 94822: () => { Module.canvas.style.cursor = 'none'; },  
 94859: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 95115: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 95166: () => { if (document.pointerLockElement) return 1; },  
 95213: () => { if (document.fullscreenElement) return 1; },  
